"""
Portfolio Optimization Module for Leveraged LP Positions - Notebook Compatible
...
class PortfolioOptimizer:
    ...
    def __init__(self, analyzer, create_position_config_func, current_price: float = 4500.0, apr_percent: float = 1000.0):
        """
    ...
    def optimize_portfolio(self, total_capital: float, range_lower: float, range_upper: float,
        ...
        if method == 'differential_evolution':
            ...
            bounds_list = [(0.1, 0.9), (0.1, 0.9), (1.0, 7.0), (1.0, 7.0)]  # 1x-7x leverage range
            ...
            bounds = Bounds(
                lb=[0.1, 0.1, 1.0, 1.0],  # Lower bounds: 1x leverage minimum
                ub=[0.9, 0.9, 7.0, 7.0]   # Upper bounds: 7x leverage maximum
            )
            ...
            x0 = [0.5, 0.5, 3.0, 3.0]  # Initial guess: 50/50 allocation, 3x leverage
